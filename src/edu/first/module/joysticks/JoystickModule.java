...
public class JoystickModule extends Module.StandardModule implements Joystick {
	 ...
	 *             when joystick is null
	 * @param joystick
	 *            the composing instance to get input from
	 */
	 ...
	 *
	 * @param port
	 *            channel in configuration of DriverStation
	 */
	 ...
	 *            the axis to read
	 * @param threshold
	 *            point at which axis is considered "on"
	 ...
	 *            the axis
	 * @param deadband
	 *            value that input should be bigger than
	 */
