...
public class EncoderModule extends Module.StandardModule implements Encoder {
	 ...
	 * @param encoder
	 *            underlying object to get input from
	 * @param inputType
	 *            which kind of input to accept
	 * @param reverseDirection
	 *            if input should be reversed
	 */
	 ...
	 *
	 * @param aChannel
	 *            first channel in digital sidecar
	 * @param bChannel
	 *            second channel in digital sidecar
	 * @param inputType
	 *            which kind of input to accept
	 * @param reverseDirection
	 *            if input should be reversed
	 ...
	 *
	 * @param distance
	 *            how much to consider one pulse
	 */
	 ...
	 *
	 * @param rate
	 *            lowest speed considered moving
	 */
