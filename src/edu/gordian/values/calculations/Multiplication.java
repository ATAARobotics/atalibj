...
public final class Multiplication extends GordianNumber {
    ...
    public static Multiplication valueOf(Scope s, String v) {
        return new Multiplication(((GordianNumber) s.toValue(v.substring(0, v.lastIndexOf('*')))),
